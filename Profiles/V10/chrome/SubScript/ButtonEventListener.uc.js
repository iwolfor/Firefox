...
document.getElementById('tabs-newtab-button').setAttribute("tooltiptext","右键：访问剪切板内容");
document.getElementById('sidebar-button').setAttribute("tooltiptext","左键：显示历史\r\n右键：显示书签");
document.getElementById('history-panelmenu').setAttribute("tooltiptext","左键：显示历史记录\r\n右键：恢复最后关闭的标签");
document.getElementById('downloads-button').setAttribute("tooltiptext","左键：显示下载进度\r\n右键：显示下载历史");
    }, cars[i] * 1000); //单位: 1秒
  }
}) ();
